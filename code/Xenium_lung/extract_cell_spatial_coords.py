...
# conda run -n SeededNTM python code/Xenium_lung/extract_cell_spatial_coords.py \
#   --data-dir data/Xemium/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases    # Complete_Cases: 25 samples, not necessary

## Incomplete_Cases 下没有找到 data.zarr，所以无法提取 spatial coords
# conda run -n SeededNTM python code/Xenium_lung/extract_cell_spatial_coords.py \
#   --data-dir data/Xemium/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Incomplete_Cases    # Incomplete_Cases: 20 samples
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/Xemium/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4"
        ),
    )
