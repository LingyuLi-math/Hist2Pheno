## 2026.08.13, add codex_escc_uni_nb_helpers for CODEX ESCC dataset

"""CODEX ESCC level012 notebook helpers (insample + StarDist multi-tier plots).

Internal tier keys match five-head training (``level3`` = level0, ``level4`` = level01).
``NCRT`` names retained below are cohort identifiers or compatibility APIs.
"""
...
# Display title, pred key, names key, y_f key, figures, and CODEX ESCC color tier.
