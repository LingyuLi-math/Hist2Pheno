#!/usr/bin/env bash
## 2026.08.20 CODEX PDAC s1167 — single-core UNI feature extraction

# cd /home/lingyu/ssd2/Python/Hist2Pheno
#
# Usage:
#   bash code/CODEX_pdac/demo_GT_feature_extraction_Single.sh [gt|stardist]
#
...
#
# Examples:
#   ACQ_ID=Charvill-94_c001_v001_r001_reg001 bash code/CODEX_pdac/demo_GT_feature_extraction_Single.sh
...
ACQ_ID="${ACQ_ID:-${HE_KEY:-Charvill-94_c001_v001_r001_reg001}}"
...
echo "=== CODEX PDAC UNI feature extraction (single) ==="
echo "Python:       ${PYTHON}"
