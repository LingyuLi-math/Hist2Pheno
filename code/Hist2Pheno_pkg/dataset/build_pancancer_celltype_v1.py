...
L2_NOTES = {
    "Tumor": "Invasive / cycling malignant parenchyma (BRCA invasive, HCC INOS±, GBM states). Reserved for CRC / Prostate tumor.",
...
RESERVED_ON_EXISTING = {
    "Tumor": "CRC; Prostate; extra HCC",
    "Epithelial": "CRC (Enterocyte/Tuft/Goblet); Prostate (Luminal)",
    "Myoepithelial": "Prostate basal",
    "Stromal": "CRC / Prostate smooth muscle; GIST tumor",
    "Neural": "Prostate / CRC / PDAC nerve",
}
