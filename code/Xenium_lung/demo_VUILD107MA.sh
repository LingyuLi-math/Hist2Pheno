...
/ssd2/users/lingyu/conda_envs/SeededNTM/bin/python code/Image_feature_extraction.py \
   ...
   --position_path data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA_cells_partitioned_by_annotation.csv \
   --rawimage_path 'data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA-HE.tif' \
   --scale_image True \
   --method UNI \
   --patch_size 16 \
   --output_img data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA_project_all_UNI/ImgEmbeddings_all/sc_pth_16_16_image \
   --output_pth data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA_project_all_UNI/ImgEmbeddings_all/sc_pth_16_16 \
   --logging data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA_project_all_UNI/ImgEmbeddings_all/ \
   --scale 0.425
...
/ssd2/users/lingyu/conda_envs/SeededNTM/bin/python code/Image_feature_extraction.py \
   --dataset sc_VUILD107MA \
   --position_path data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA_Float_prob001_nms_03.csv \
   --rawimage_path 'data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA-HE.tif' \
   --scale_image True \
   --method UNI \
   --patch_size 16 \
   --output_img data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA_project_all_UNI/ImgEmbeddings_all_stardist/sc_pth_16_16_image \
   --output_pth data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA_project_all_UNI/ImgEmbeddings_all_stardist/sc_pth_16_16 \
   --logging data/Xemiun/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases_Select4/VUILD107MA/VUILD107MA_project_all_UNI/ImgEmbeddings_all_stardist/ \
   --scale 0.425
