...
conda run -n SeededNTM python code/Xenium_lung/extract_cell_spatial_coords.py \
  --data-dir data/Xemium/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data/Complete_Cases
```
...
conda activate SeededNTM
SAMPLE=VUILD107MA
DATA=data/Xemium/weiqin/SpatialPF-NGenetics/Spatial-PF-Processed/Data
