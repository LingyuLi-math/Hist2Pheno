...
########################################################
## 2026.07.05 LLY: Step 4 on Incomplete_Cases
## Output per sample: {sample}_all_features_stardist.h5ad
## (NOT {sample}_matched_features_stardist.h5ad — that is Step 3 / --steps stardist_h5ad)
########################################################
## cd /home/lingyu/ssd2/Python/Hist2Pheno
## conda activate SeededNTM
## python -u code/Xenium_lung/transer_embedding_label_h5ad.py --cases-set incomplete --steps stardist_all_h5ad
